module.exports = {
  ...
  it: {
    ...
    2: {
      ...
      d: 'Modificare i dati sul server',
      e: 'Aggiungere stili all’applicazione React',
    },
    3: {
      a: 'Node.js ed Express',
      b: 'Pubblicare l’applicazione su Internet',
      c: 'Salvare i dati in MongoDB',
      d: 'Validazione ed ESLint',
    },
    4: {
      a: 'Struttura del backend e introduzione ai test',
      b: 'Testare il backend',
      c: 'Gestione degli utenti',
      d: 'Autenticazione tramite token',
    },
    5: {
