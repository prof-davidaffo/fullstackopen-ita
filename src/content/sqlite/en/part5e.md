...
**SQLite track:** keep your local Part 4 backend and the authenticated Axios service from 5a. External repositories show the original version; do not replace your backend with them. The deployment chapter follows these exercises.
